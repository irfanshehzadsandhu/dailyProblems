...
app/
  controllers/
    ...
    enforce the limit. All the finds are scoped to the current account,
    (the current_account method) is defined in lib/subscription_system).
    Use this pattern throughout your application to make sure users only see
    the data associated with their account.
